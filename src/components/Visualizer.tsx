...
const Visualizer: React.FC = () => {
  ...
  const startSort = async (algorithm: SortGenerator) => {
    ...
    setSorting(true);
    const generator = algorithm([...original]);
  ...
  return (
    <div className="visualizer">
      <Controls onStart={startSort} onReset={resetArray} onPause={pauseSort} isPaused={isPaused} disabled={sorting} compareCount={compareCount}/>
